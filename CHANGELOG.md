...
* New feature: adding https port to st2web service if .Values.st2web.service.ssl equals `true`. .Values.st2web.service.ssl defaults to `false` for backward compatibility. (#267) (by @sandesvitor)
